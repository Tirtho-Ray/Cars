...
const ShowLamorgini = ({car}) => {
    ...
    return (
        <div> 
          <div className="card card-compact w-72 md:w-80 lg:w-[500px] bg-base-100 shadow-xl mx-auto h-[500px]">
            <figure><img src={Picture} alt="Shoes"  className='rounded-md h-72 lg:w-[500px]'/></figure>
